...
func PostListReplyTime(categoryId uint, left int, right int) (postList *gin.H, err error) {
	posts, totNum, curNum, err := dao.PostQueryByCategoryIdReplyTime(categoryId, left, right)
	if err != nil {
		return
	}
